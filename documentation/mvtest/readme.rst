.. This is a simple document that will be used to generate the README.md file
	with instructions for installing MVtest, and a link to the online documentation.
